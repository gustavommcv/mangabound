...
6. **Use.** The results screen opens a book or shows it in its folder by _artifact id_. Sharing starts the OPDS server on the network interface the person chose, and it stops when the app quits.
