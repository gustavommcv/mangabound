...
| [0007](0007-library-indexing-and-opds-delivery.md)                  | Accepted (amended by 0009, 0010, 0018, 0019)                   | Per-folder library catalog and an opt-in, authenticated OPDS server                   |
