...
| [0003](0003-bundled-version-pinned-cli-binaries.md)                 | Accepted (amended by 0017)                                     | Bundled, pinned mangabind and mangapress release binaries                             |
| [0004](0004-testing-and-ci-definition-of-done.md)                   | Accepted                                                       | Four testing layers and cross-platform CI gates                                       |
| [0005](0005-product-boundaries-and-anti-goals.md)                   | Accepted (amended by 0008, 0009, 0010, 0011, 0012, 0013, 0018) | Product responsibilities, capabilities, and explicit anti-goals                       |
| [0006](0006-cli-first-tool-boundary.md)                             | Accepted                                                       | mangabind and mangapress stay CLI-first; Mangabound only orchestrates                 |
| [0007](0007-library-indexing-and-opds-delivery.md)                  | Accepted (amended by 0009, 0010, 0018, 0019, 0020)             | Per-folder library catalog and an opt-in, authenticated OPDS server                   |
...
| [0010](0010-input-queue.md)                                         | Accepted (amended by 0012, 0016)                               | The entry screen is a queue of folders and comic files                                |
...
| [0016](0016-one-share-panel-fixed-title-bar-clickable-drop-area.md) | Accepted                                                       | One place to share, a title bar that stays, and a drop area that can be clicked       |
| [0017](0017-bundled-tools-are-updated-by-hand.md)                   | Accepted                                                       | The bundled tools are updated by hand, with a script, not by a scheduled workflow     |
| [0018](0018-opds-basic-auth-only-optionally-blank.md)               | Accepted                                                       | OPDS authentication is Basic-only, and may be left blank                              |
| [0019](0019-opds-server-binds-a-fixed-port.md)                      | Accepted                                                       | The OPDS server binds a fixed port, so a catalog added once keeps working             |
| [0020](0020-opds-also-lists-untracked-files.md)                     | Accepted                                                       | OPDS also lists comic/book files the catalog does not track, as "Other files"         |
| [0021](0021-windows-installer-stays-squirrel.md)                    | Accepted                                                       | Windows stays on Squirrel; a wizard-based MSI was tried and reverted                  |
